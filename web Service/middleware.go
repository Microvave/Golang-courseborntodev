...
func middleware(handlaer http.Handler) http.Handler {
	return http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		fmt.Println("before mideleware start")

		handlaer.ServeHTTP(w, r)
		fmt.Println("mideleware END")
	})
}
func main() {
	courseItem := http.HandlerFunc(courseHandler)
	courseList := http.HandlerFunc(coursesHandler)
	http.Handle("/course/", middleware(courseItem))
	http.Handle("/courses", middleware(courseList))
